...
const FloodsReady = () => {
  return (
    <div className="mt-28 app-container">
      <header>
        <h1>Flood Response Plan</h1>
      </header>

      <section className="section">
        <h2>Immediate Safety Assessment:</h2>
        <ul>
          <li>
            Prioritize safety by checking for injuries and providing first aid.
          </li>
      ...
      <section className="section-ready">
        ...
        <ul>
          ...
          <li>
            Share information about the extent of flooding and immediate needs.
          </li>
        </ul>
      </section>
      ...
      <section className="section-ready">
        ...
        <ul>
          <li>Mobilize community resources for collective recovery efforts.</li>
          <li>
      ...
      <section className="section-ready">
        <h2>Insurance and Financial Preparedness:</h2>
        <ul>
      ...
      <section className="section-ready">
        <h2>Vegetative and Natural Solutions:</h2>
        <ul>
          <li>
      ...
      <section className="section-ready">
        <h2>Regular Drills and Exercises:</h2>
        <ul>
          <li>
            Conduct regular flood drills to reinforce emergency response plans.
          </li>
